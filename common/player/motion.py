...
class Motion:
    ...
    def fill(self, datagram_iterator):
        self.acceleration.set_x(datagram_iterator.get_float32())
        self.acceleration.set_y(datagram_iterator.get_float32())
        self.velocity.set_x(datagram_iterator.get_float32())
        self.velocity.set_y(datagram_iterator.get_float32())
        self.position.set_x(datagram_iterator.get_float32())
        self.position.set_y(datagram_iterator.get_float32())
        self.angle = datagram_iterator.get_float32()

    def dump(self, datagram):
        datagram.add_float32(self.acceleration.get_x())
        datagram.add_float32(self.acceleration.get_y())
        datagram.add_float32(self.velocity.get_x())
        datagram.add_float32(self.velocity.get_y())
        datagram.add_float32(self.position.get_x())
        datagram.add_float32(self.position.get_y())
        datagram.add_float32(self.angle)
